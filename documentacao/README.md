...
Esta pasta reúne a documentação usada para explicar como o projeto foi construído, quais regras foram aplicadas e como interpretar os resultados.

## Ordem recomendada de leitura

1. [Arquitetura do Modelo](arquitetura_modelo.md)  
   Entenda as tabelas, granularidades e relacionamentos.

2. [Processo de ETL e Data Quality](processo_etl.md)  
   Veja como os dados foram tratados e validados no Power Query.

3. [Dicionário de Dados](dicionario_dados.md)  
   Consulte o significado dos principais campos utilizados.
...
|---|---|
| Arquitetura do Modelo | explicar como as tabelas se conectam |
